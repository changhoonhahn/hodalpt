...
def run_bispec_fiducial_pylauncher(i0, i1, nodes=8, time=6, queue='normal',
    ...
    slurm = '\n'.join([
        ...
        '',
        # capture TACC pylauncher path before conda wipes PYTHONPATH
        'PYLAUNCHER_DIR=$(python3 -c "import pylauncher, os; print(os.path.dirname(os.path.abspath(pylauncher.__file__)))")',
        '',
        'unset PYTHONPATH',
        'source ~/.bashrc',
        '',
        ...
        '',
        # restore pylauncher into conda env's PYTHONPATH
        'export PYTHONPATH=${PYLAUNCHER_DIR}:${PYTHONPATH}',
        '',
