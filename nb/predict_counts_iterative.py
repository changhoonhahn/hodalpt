...
dm_filename =  '/Users/mcc3842/CosmicSim2025/data/quijote/fiducial_HR/0/alpt/super_deltaBOX.dat'
tweb_filename = '/Users/mcc3842/CosmicSim2025/data/quijote/fiducial_HR/0/alpt/Tweb_.dat' 
twebdelta_filename = '/Users/mcc3842/CosmicSim2025/data/quijote/fiducial_HR/0/alpt/TwebDelta_.dat' 
gal_filename = 'CMASS_gal_ngp.DAT' 

out_filename = 'CMASS_gal_ngp_mock_nonlocal.DAT'
...
# 1 1 : [ 0.29685723 82.91475146]
# 1 2: [ 1.06796392 68.33632545]
# 1 3: [ 1.99415336 39.27743698]
# 1 4: [ 0.85211754 25.15950722]
# 2 1: [ 0.63162251 87.1500282 ]
# 2 2: [ 1.61120672 25.42614578]
# 2 3: [ 2.51800086 71.29493583]
# 2 4: [ 2.56070147 77.82969567]
# 3 1: [ 1.20938235 70.43144589]
# 3 2: [0.36272172 3.71638296]
# 3 3: [ 1.73030157 71.68769349]
# 3 4: [ 0.85211754 56.65364231]
# 4 4: [ 0.85211754 25.15950722]
...
for twebenv in twebenvs:
    for twebdeltaenv in twebdeltaenvs:
        ...
        print('Doing env %d %d' %(twebenv, twebdeltaenv))
        ...
        #parslist.append(normalization, alpha, beta)
